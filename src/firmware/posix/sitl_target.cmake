...
ExternalProject_Add(rotors_simulator_rotors_gazebo_plugins
	...
	CMAKE_ARGS -DCMAKE_INSTALL_PREFIX:PATH=${CMAKE_INSTALL_PREFIX} -DNO_ROS=TRUE -DMAVLINK_INTERFACE=TRUE -DBUILD_OPTICAL_FLOW_PLUGIN=TRUE
	CMAKE_CACHE_ARGS -DCMAKE_MODULE_PATH:PATH=${CMAKE_MODULE_PATH} -DCMAKE_PREFIX_PATH:PATH=${CMAKE_PREFIX_PATH} 

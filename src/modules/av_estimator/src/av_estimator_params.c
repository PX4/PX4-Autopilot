...
/* Filter 1 */
PARAM_DEFINE_FLOAT(ATT_VEL_K1_V, 1.0f); 
PARAM_DEFINE_FLOAT(ATT_VEL_K1_VC, 0.0f);
PARAM_DEFINE_FLOAT(ATT_VEL_K1_R, 0.01f);
PARAM_DEFINE_FLOAT(ATT_VEL_K1_RC, 0.0f);
PARAM_DEFINE_FLOAT(ATT_VEL_K1_U, 0.1f);
PARAM_DEFINE_FLOAT(ATT_VEL_K1_MU, 0.6f);
...
PARAM_DEFINE_FLOAT(ATT_VEL_K1_VICON, 1.0f);


/* Filter 2 */
PARAM_DEFINE_FLOAT(ATT_VEL_K2_V, 4.0f); 
PARAM_DEFINE_FLOAT(ATT_VEL_K2_VC, 0.0f);
PARAM_DEFINE_FLOAT(ATT_VEL_K2_R, 0.03f);
PARAM_DEFINE_FLOAT(ATT_VEL_K2_RC, 0.0f);
PARAM_DEFINE_FLOAT(ATT_VEL_K2_U, 0.001f);
PARAM_DEFINE_FLOAT(ATT_VEL_K2_W, 0.1f);

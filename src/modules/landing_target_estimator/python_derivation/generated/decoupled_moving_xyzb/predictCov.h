...
void Predictcov(const Scalar dt, const Scalar input_var, const Scalar bias_var,
		const Scalar acc_var, const matrix::Matrix<Scalar, 4, 4> &covariance,
		matrix::Matrix<Scalar, 4, 4> *const cov_updated = nullptr)
{
	// Total ops: 60
	...
	if (cov_updated != nullptr) {
		matrix::Matrix<Scalar, 4, 4> &_cov_updated = (*cov_updated);

	       ...
	       matrix::Matrix<Scalar, 9, 1> *const state_updated = nullptr)
{
	...
	const Scalar _tmp5 = Scalar(1.0) * state(6, 0);
	const Scalar _tmp6 = Scalar(1.0) * state(7, 0);
	const Scalar _tmp7 = Scalar(1.0) * state(8, 0);
	...
	if (state_updated != nullptr) {
		...
		_state_updated(0, 0) =
			-_tmp0 * acc(0, 0) + _tmp0 * state(6, 0) - _tmp1 * dt + Scalar(1.0) * state(0, 0);
		_state_updated(1, 0) =
			-_tmp0 * acc(1, 0) + _tmp0 * state(7, 0) - _tmp2 * dt + Scalar(1.0) * state(1, 0);
		_state_updated(2, 0) =
			-_tmp0 * acc(2, 0) + _tmp0 * state(8, 0) - _tmp3 * dt + Scalar(1.0) * state(2, 0);
		...
		_state_updated(6, 0) = _tmp5;
		_state_updated(7, 0) = _tmp6;
		_state_updated(8, 0) = _tmp7;
	}

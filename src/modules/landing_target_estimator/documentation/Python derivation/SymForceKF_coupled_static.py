...
def generate_px4_function(function_name, output_names):
    ...
    metadata = codegen.generate_function(
            output_dir="generated coupled static",
...
def computeProcessNoise(dt: sf.Scalar, _input_var: MDirections, _bias_var: MDirections) -> (MState):
...
def predictCov(dt: sf.Scalar, _input_var: MDirections, _bias_var: MDirections, _covariance: MState) -> (MState):
    identity = sf.Matrix([  [1, 0, 0],
                            [0, 1, 0],
                            [0, 0, 1]])

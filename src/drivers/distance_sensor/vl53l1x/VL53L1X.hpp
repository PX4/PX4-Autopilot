...
#define VL53L1X_BASEADDR 0b0101001 // 7-bit address 0x29

#define VL53L1X_MAX_RANGING_DISTANCE 3.6f
...
{
public:
	VL53L1X(uint8_t rotation = distance_sensor_s::ROTATION_DOWNWARD_FACING, int bus = VL53L1X_BUS_DEFAULT,

...
#ifndef MAX21100_REG_H_
#define MAX21100_REG_H_
...
typedef struct max21100_reg_fifo_status_t{
	...
	unsigned	rfu				: 3;
} max21100_reg_fifo_status;

typedef union max21100_reg_rst_t{
	uint8_t val;
	struct{
...
#define MAX21100_BIT_HPF_G_RST 	0x01
#define MAX21100_BIT_HPF_A_RST 	0x02
#define MAX21100_BIT_PAR_RST 	0x04
#define MAX21100_BIT_RST_ALL 	0x07


typedef union max21100_reg_power_cfg_t{
	uint8_t val;
	struct{
		unsigned	gyro_en_x		: 1;
		unsigned	gyro_en_y		: 1;
		unsigned	gyro_en_z		: 1;
...
#define MAX21100_BIT_GYRO_EN_X 	0x01
#define MAX21100_BIT_GYRO_EN_Y 	0x02
#define MAX21100_BIT_GYRO_EN_Z 	0x04
#define MAX21100_BIT_DSYNC_SEL	0x80
...
enum{
	MAX21100_ACCEL_MODE_POWERDOWN 	= 0,
	MAX21100_ACCEL_MODE_NORMAL 		= 3,
};
...
enum{
	MAX21100_GYRO_DOUT_FS_2000 	= 0,
	MAX21100_GYRO_DOUT_FS_1000 	= 1,
	MAX21100_GYRO_DOUT_FS_500 	= 2,
	MAX21100_GYRO_DOUT_FS_250 	= 3
};
...
typedef union max21100_reg_pwr_acc_t{
	uint8_t val;
	struct{
		unsigned	accel_en_x	: 1;
		unsigned	accel_en_y	: 1;
		unsigned	accel_en_z	: 1;
		unsigned	self_test_axis	: 2;
		unsigned	self_test_dir	: 2;
		unsigned	acc_fsc			: 2;
	} _;
} max21100_reg_pwr_acc;

#define MAX21100_BIT_ACCEL_EN_X 	0x01
#define MAX21100_BIT_ACCEL_EN_Y 	0x02
#define MAX21100_BIT_ACCEL_EN_Z 	0x04
#define MAX21100_BIT_ACCEL_EN_ALL 	0x07

enum{
	MAX21100_ACCEL_SELF_TEST_NONE 		= 0,
	MAX21100_ACCEL_SELF_TEST_X_AXIS 	= 1,
	MAX21100_ACCEL_SELF_TEST_Y_AXIS 	= 2,
	MAX21100_ACCEL_SELF_TEST_Z_AXIS 	= 3,
};

enum{
	MAX21100_ACCEL_SELF_TEST_POSITIVE	= 0,
	MAX21100_ACCEL_SELF_TEST_NEGATIVE	= 1,
};

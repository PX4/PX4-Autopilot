 ...
 * @file LSM6DSR.hpp
 *
 * Driver for the ST LSM6DSR connected via SPI.
 *
 */

#pragma once

#include "ST_LSM6DSR_Registers.hpp"
...
using namespace ST_LSM6DSR;

class LSM6DSR : public device::SPI, public I2CSPIDriver<LSM6DSR>
{
public:
	LSM6DSR(const I2CSPIDriverConfig &config);
	~LSM6DSR() override;

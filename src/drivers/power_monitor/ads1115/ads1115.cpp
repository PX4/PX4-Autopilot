...
#define ADS1115_CHANNEL_ONE	(0xC2A3) // 1 100 001 0 101 0 0 0 11
#define ADS1115_CHANNEL_TWO	(0xD2A3) // 1 101 001 0 101 0 0 0 11
#define ADS1115_CHANNEL_THREE 	(0xE2A3) // 1 110 001 0 101 0 0 0 11
#define ADS1115_CHANNEL_FOUR	(0xF2A3) // 1 111 001 0 101 0 0 0 11

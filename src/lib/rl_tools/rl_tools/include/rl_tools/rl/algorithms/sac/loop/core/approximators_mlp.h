...
namespace rl_tools::rl::algorithms::sac::loop::core{
    ...
    struct ConfigApproximatorsMLP{
        ...
        struct Actor{
            ...
            using MLP_CONFIG = nn_models::mlp::Configuration<TYPE_POLICY, TI, 2*ENVIRONMENT::ACTION_DIM, PARAMETERS::ACTOR_NUM_LAYERS, PARAMETERS::ACTOR_HIDDEN_DIM, PARAMETERS::ACTOR_ACTIVATION_FUNCTION,  nn::activation_functions::IDENTITY, typename PARAMETERS::INITIALIZER>;

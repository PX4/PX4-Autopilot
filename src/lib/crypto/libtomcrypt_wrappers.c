...
struct ltc_hash_descriptor hash_descriptor[] = {{"sha256",
						 0,
						 32,
						 64,
...
struct ltc_prng_descriptor prng_descriptor[] = {{"sprng", 0, &sprng_start, &sprng_add_entropy, &sprng_ready,
...
void libtomcrypt_init(void) { ltc_mp = ltm_desc; }

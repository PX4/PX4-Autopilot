...
extern boolean_T radarControl(int16_T radar[32], real32_T front_distance, real32_T sonar_obstacle[3], boolean_T sonar_flags[2], const real32_T settings[10], real32_T *x_control, real32_T *y_control, real32_T *yaw_control);
#endif

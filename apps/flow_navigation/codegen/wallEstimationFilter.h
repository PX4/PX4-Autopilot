...
extern void wallEstimationFilter(const real32_T radar_filtered_k[32], const real32_T radar_weights_k[32], const real32_T flow_left[10], const real32_T flow_right[10], real32_T front_distance, uint16_T quality, const real32_T speed[2], const real32_T position_update[2], real32_T attitude_update, const real32_T thresholds[3], real32_T radar[32], real32_T radar_filtered[32], real32_T radar_weights[32]);
#endif

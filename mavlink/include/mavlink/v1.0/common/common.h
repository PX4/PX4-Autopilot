...
enum MAV_CMD
{
	...
	MAV_CMD_NAV_ROI=80, /* Sets the region of interest (ROI) for a sensor set or the vehicle itself. This can then be used by the vehicles control system to control the vehicle attitude and the attitude of various sensors such as cameras. |Region of intereset mode. (see MAV_ROI enum)| MISSION index/ target ID. (see MAV_ROI enum)| ROI index (allows a vehicle to manage multiple ROI's)| Interpolation mode for MAV_ROI_FOLLOW mode. 0: No interpolation, 1: Linear interpolation, 2: Spline interpolation| x the location of the fixed ROI (see MAV_FRAME)| y| z|  */
...
enum MAV_ROI
{
	...
	MAV_ROI_FOLLOW=5, /* Follow system with given id. Position offset is the difference between ROI and following waypoint. | */
	MAV_ROI_ENUM_END=6, /*  | */
};
#endif

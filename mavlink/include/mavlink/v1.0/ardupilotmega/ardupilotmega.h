...
/** @brief  */
#ifndef HAVE_ENUM_CAMERA_EVENT_TYPES
#define HAVE_ENUM_CAMERA_EVENT_TYPES
typedef enum CAMERA_EVENT_TYPES
{
...
#include "./mavlink_msg_camera_event.h"

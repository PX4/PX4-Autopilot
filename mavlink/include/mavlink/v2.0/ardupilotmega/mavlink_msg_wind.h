...
#define MAVLINK_MSG_ID_WIND_TUPLE 2, MAVLINK_MSG_ID_WIND
#else
#define MAVLINK_MSG_ID_WIND_TUPLE MAVLINK_MSG_ID_WIND
#endif
...
static inline void mavlink_msg_wind_send(mavlink_channel_t chan, float direction, float speed, float speed_z)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WIND_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_WIND_LEN, MAVLINK_MSG_ID_WIND_CRC);
#endif
}
...
static inline void mavlink_msg_wind_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float direction, float speed, float speed_z)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WIND_TUPLE, buf, MAVLINK_MSG_ID_WIND_LEN, MAVLINK_MSG_ID_WIND_CRC);
#else

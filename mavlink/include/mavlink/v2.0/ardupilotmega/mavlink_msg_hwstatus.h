...
#define MAVLINK_MSG_ID_HWSTATUS_TUPLE 2, MAVLINK_MSG_ID_HWSTATUS
#else
#define MAVLINK_MSG_ID_HWSTATUS_TUPLE MAVLINK_MSG_ID_HWSTATUS
#endif
...
static inline void mavlink_msg_hwstatus_send(mavlink_channel_t chan, uint16_t Vcc, uint8_t I2Cerr)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HWSTATUS_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_HWSTATUS_LEN, MAVLINK_MSG_ID_HWSTATUS_CRC);
#endif
}
...
static inline void mavlink_msg_hwstatus_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t Vcc, uint8_t I2Cerr)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HWSTATUS_TUPLE, buf, MAVLINK_MSG_ID_HWSTATUS_LEN, MAVLINK_MSG_ID_HWSTATUS_CRC);
#else

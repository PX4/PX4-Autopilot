...
#define MAVLINK_MSG_ID_RANGEFINDER_TUPLE 2, MAVLINK_MSG_ID_RANGEFINDER
#else
#define MAVLINK_MSG_ID_RANGEFINDER_TUPLE MAVLINK_MSG_ID_RANGEFINDER
#endif
...
static inline void mavlink_msg_rangefinder_send(mavlink_channel_t chan, float distance, float voltage)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RANGEFINDER_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_RANGEFINDER_LEN, MAVLINK_MSG_ID_RANGEFINDER_CRC);
#endif
}
...
static inline void mavlink_msg_rangefinder_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float distance, float voltage)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RANGEFINDER_TUPLE, buf, MAVLINK_MSG_ID_RANGEFINDER_LEN, MAVLINK_MSG_ID_RANGEFINDER_CRC);
#else

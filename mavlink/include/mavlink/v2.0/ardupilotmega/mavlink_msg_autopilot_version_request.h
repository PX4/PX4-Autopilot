...
#define MAVLINK_MSG_ID_AUTOPILOT_VERSION_REQUEST_TUPLE 2, MAVLINK_MSG_ID_AUTOPILOT_VERSION_REQUEST
#else
#define MAVLINK_MSG_ID_AUTOPILOT_VERSION_REQUEST_TUPLE MAVLINK_MSG_ID_AUTOPILOT_VERSION_REQUEST
#endif
...
static inline void mavlink_msg_autopilot_version_request_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_AUTOPILOT_VERSION_REQUEST_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_AUTOPILOT_VERSION_REQUEST_LEN, MAVLINK_MSG_ID_AUTOPILOT_VERSION_REQUEST_CRC);
#endif
}
...
static inline void mavlink_msg_autopilot_version_request_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_AUTOPILOT_VERSION_REQUEST_TUPLE, buf, MAVLINK_MSG_ID_AUTOPILOT_VERSION_REQUEST_LEN, MAVLINK_MSG_ID_AUTOPILOT_VERSION_REQUEST_CRC);
#else

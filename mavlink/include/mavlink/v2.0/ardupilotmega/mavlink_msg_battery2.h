...
#define MAVLINK_MSG_ID_BATTERY2_TUPLE 2, MAVLINK_MSG_ID_BATTERY2
#else
#define MAVLINK_MSG_ID_BATTERY2_TUPLE MAVLINK_MSG_ID_BATTERY2
#endif
...
static inline void mavlink_msg_battery2_send(mavlink_channel_t chan, uint16_t voltage, int16_t current_battery)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_BATTERY2_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_BATTERY2_LEN, MAVLINK_MSG_ID_BATTERY2_CRC);
#endif
}
...
static inline void mavlink_msg_battery2_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t voltage, int16_t current_battery)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_BATTERY2_TUPLE, buf, MAVLINK_MSG_ID_BATTERY2_LEN, MAVLINK_MSG_ID_BATTERY2_CRC);
#else

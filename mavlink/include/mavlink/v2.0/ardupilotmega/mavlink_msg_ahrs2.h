...
#define MAVLINK_MSG_ID_AHRS2_TUPLE 2, MAVLINK_MSG_ID_AHRS2
#else
#define MAVLINK_MSG_ID_AHRS2_TUPLE MAVLINK_MSG_ID_AHRS2
#endif
...
static inline void mavlink_msg_ahrs2_send(mavlink_channel_t chan, float roll, float pitch, float yaw, float altitude, int32_t lat, int32_t lng)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_AHRS2_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_AHRS2_LEN, MAVLINK_MSG_ID_AHRS2_CRC);
#endif
}
...
static inline void mavlink_msg_ahrs2_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float roll, float pitch, float yaw, float altitude, int32_t lat, int32_t lng)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_AHRS2_TUPLE, buf, MAVLINK_MSG_ID_AHRS2_LEN, MAVLINK_MSG_ID_AHRS2_CRC);
#else

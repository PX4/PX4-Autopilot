...
#define MAVLINK_MSG_ID_AP_ADC_TUPLE 2, MAVLINK_MSG_ID_AP_ADC
#else
#define MAVLINK_MSG_ID_AP_ADC_TUPLE MAVLINK_MSG_ID_AP_ADC
#endif
...
static inline void mavlink_msg_ap_adc_send(mavlink_channel_t chan, uint16_t adc1, uint16_t adc2, uint16_t adc3, uint16_t adc4, uint16_t adc5, uint16_t adc6)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_AP_ADC_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_AP_ADC_LEN, MAVLINK_MSG_ID_AP_ADC_CRC);
#endif
}
...
static inline void mavlink_msg_ap_adc_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t adc1, uint16_t adc2, uint16_t adc3, uint16_t adc4, uint16_t adc5, uint16_t adc6)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_AP_ADC_TUPLE, buf, MAVLINK_MSG_ID_AP_ADC_LEN, MAVLINK_MSG_ID_AP_ADC_CRC);
#else

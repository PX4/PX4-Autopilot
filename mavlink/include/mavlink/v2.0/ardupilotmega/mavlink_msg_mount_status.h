...
#define MAVLINK_MSG_ID_MOUNT_STATUS_TUPLE 2, MAVLINK_MSG_ID_MOUNT_STATUS
#else
#define MAVLINK_MSG_ID_MOUNT_STATUS_TUPLE MAVLINK_MSG_ID_MOUNT_STATUS
#endif
...
static inline void mavlink_msg_mount_status_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, int32_t pointing_a, int32_t pointing_b, int32_t pointing_c)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MOUNT_STATUS_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_MOUNT_STATUS_LEN, MAVLINK_MSG_ID_MOUNT_STATUS_CRC);
#endif
}
...
static inline void mavlink_msg_mount_status_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, int32_t pointing_a, int32_t pointing_b, int32_t pointing_c)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MOUNT_STATUS_TUPLE, buf, MAVLINK_MSG_ID_MOUNT_STATUS_LEN, MAVLINK_MSG_ID_MOUNT_STATUS_CRC);
#else

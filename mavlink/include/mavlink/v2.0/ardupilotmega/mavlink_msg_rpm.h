...
#define MAVLINK_MSG_ID_RPM_TUPLE 2, MAVLINK_MSG_ID_RPM
#else
#define MAVLINK_MSG_ID_RPM_TUPLE MAVLINK_MSG_ID_RPM
#endif
...
static inline void mavlink_msg_rpm_send(mavlink_channel_t chan, float rpm1, float rpm2)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RPM_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_RPM_LEN, MAVLINK_MSG_ID_RPM_CRC);
#endif
}
...
static inline void mavlink_msg_rpm_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float rpm1, float rpm2)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RPM_TUPLE, buf, MAVLINK_MSG_ID_RPM_LEN, MAVLINK_MSG_ID_RPM_CRC);
#else

...
#define MAVLINK_MSG_ID_PID_TUNING_TUPLE 2, MAVLINK_MSG_ID_PID_TUNING
#else
#define MAVLINK_MSG_ID_PID_TUNING_TUPLE MAVLINK_MSG_ID_PID_TUNING
#endif
...
static inline void mavlink_msg_pid_tuning_send(mavlink_channel_t chan, uint8_t axis, float desired, float achieved, float FF, float P, float I, float D)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PID_TUNING_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_PID_TUNING_LEN, MAVLINK_MSG_ID_PID_TUNING_CRC);
#endif
}
...
static inline void mavlink_msg_pid_tuning_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t axis, float desired, float achieved, float FF, float P, float I, float D)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PID_TUNING_TUPLE, buf, MAVLINK_MSG_ID_PID_TUNING_LEN, MAVLINK_MSG_ID_PID_TUNING_CRC);
#else

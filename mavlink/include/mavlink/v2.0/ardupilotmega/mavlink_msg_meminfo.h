...
#define MAVLINK_MSG_ID_MEMINFO_TUPLE 2, MAVLINK_MSG_ID_MEMINFO
#else
#define MAVLINK_MSG_ID_MEMINFO_TUPLE MAVLINK_MSG_ID_MEMINFO
#endif
...
static inline void mavlink_msg_meminfo_send(mavlink_channel_t chan, uint16_t brkval, uint16_t freemem)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MEMINFO_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_MEMINFO_LEN, MAVLINK_MSG_ID_MEMINFO_CRC);
#endif
}
...
static inline void mavlink_msg_meminfo_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t brkval, uint16_t freemem)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MEMINFO_TUPLE, buf, MAVLINK_MSG_ID_MEMINFO_LEN, MAVLINK_MSG_ID_MEMINFO_CRC);
#else

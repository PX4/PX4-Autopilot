...
#define MAVLINK_MSG_ID_FENCE_STATUS_TUPLE 2, MAVLINK_MSG_ID_FENCE_STATUS
#else
#define MAVLINK_MSG_ID_FENCE_STATUS_TUPLE MAVLINK_MSG_ID_FENCE_STATUS
#endif
...
static inline void mavlink_msg_fence_status_send(mavlink_channel_t chan, uint8_t breach_status, uint16_t breach_count, uint8_t breach_type, uint32_t breach_time)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_FENCE_STATUS_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_FENCE_STATUS_LEN, MAVLINK_MSG_ID_FENCE_STATUS_CRC);
#endif
}
...
static inline void mavlink_msg_fence_status_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t breach_status, uint16_t breach_count, uint8_t breach_type, uint32_t breach_time)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_FENCE_STATUS_TUPLE, buf, MAVLINK_MSG_ID_FENCE_STATUS_LEN, MAVLINK_MSG_ID_FENCE_STATUS_CRC);
#else

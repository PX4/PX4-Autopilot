...
#define MAVLINK_MSG_ID_ATTITUDE_TUPLE 0, MAVLINK_MSG_ID_ATTITUDE
#else
#define MAVLINK_MSG_ID_ATTITUDE_TUPLE MAVLINK_MSG_ID_ATTITUDE
#endif
...
static inline void mavlink_msg_attitude_send(mavlink_channel_t chan, uint32_t time_boot_ms, float roll, float pitch, float yaw, float rollspeed, float pitchspeed, float yawspeed)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ATTITUDE_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_ATTITUDE_LEN, MAVLINK_MSG_ID_ATTITUDE_CRC);
#endif
}
...
static inline void mavlink_msg_attitude_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, float roll, float pitch, float yaw, float rollspeed, float pitchspeed, float yawspeed)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ATTITUDE_TUPLE, buf, MAVLINK_MSG_ID_ATTITUDE_LEN, MAVLINK_MSG_ID_ATTITUDE_CRC);
#else

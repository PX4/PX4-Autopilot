...
#define MAVLINK_MSG_ID_DEBUG_TUPLE 0, MAVLINK_MSG_ID_DEBUG
#else
#define MAVLINK_MSG_ID_DEBUG_TUPLE MAVLINK_MSG_ID_DEBUG
#endif
...
static inline void mavlink_msg_debug_send(mavlink_channel_t chan, uint32_t time_boot_ms, uint8_t ind, float value)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_DEBUG_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_DEBUG_LEN, MAVLINK_MSG_ID_DEBUG_CRC);
#endif
}
...
static inline void mavlink_msg_debug_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, uint8_t ind, float value)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_DEBUG_TUPLE, buf, MAVLINK_MSG_ID_DEBUG_LEN, MAVLINK_MSG_ID_DEBUG_CRC);
#else

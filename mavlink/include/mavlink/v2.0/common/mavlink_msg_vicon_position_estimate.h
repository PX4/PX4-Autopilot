...
#define MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE_TUPLE 0, MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE
#else
#define MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE_TUPLE MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE
#endif
...
static inline void mavlink_msg_vicon_position_estimate_send(mavlink_channel_t chan, uint64_t usec, float x, float y, float z, float roll, float pitch, float yaw)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE_LEN, MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE_CRC);
#endif
}
...
static inline void mavlink_msg_vicon_position_estimate_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t usec, float x, float y, float z, float roll, float pitch, float yaw)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE_TUPLE, buf, MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE_LEN, MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE_CRC);
#else

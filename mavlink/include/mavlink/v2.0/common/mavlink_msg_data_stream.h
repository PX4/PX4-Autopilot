...
#define MAVLINK_MSG_ID_DATA_STREAM_TUPLE 0, MAVLINK_MSG_ID_DATA_STREAM
#else
#define MAVLINK_MSG_ID_DATA_STREAM_TUPLE MAVLINK_MSG_ID_DATA_STREAM
#endif
...
static inline void mavlink_msg_data_stream_send(mavlink_channel_t chan, uint8_t stream_id, uint16_t message_rate, uint8_t on_off)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_DATA_STREAM_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_DATA_STREAM_LEN, MAVLINK_MSG_ID_DATA_STREAM_CRC);
#endif
}
...
static inline void mavlink_msg_data_stream_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t stream_id, uint16_t message_rate, uint8_t on_off)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_DATA_STREAM_TUPLE, buf, MAVLINK_MSG_ID_DATA_STREAM_LEN, MAVLINK_MSG_ID_DATA_STREAM_CRC);
#else

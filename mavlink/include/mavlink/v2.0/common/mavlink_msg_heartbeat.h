...
#define MAVLINK_MSG_ID_HEARTBEAT_TUPLE 0, MAVLINK_MSG_ID_HEARTBEAT
#else
#define MAVLINK_MSG_ID_HEARTBEAT_TUPLE MAVLINK_MSG_ID_HEARTBEAT
#endif
...
static inline void mavlink_msg_heartbeat_send(mavlink_channel_t chan, uint8_t type, uint8_t autopilot, uint8_t base_mode, uint32_t custom_mode, uint8_t system_status)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HEARTBEAT_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_HEARTBEAT_LEN, MAVLINK_MSG_ID_HEARTBEAT_CRC);
#endif
}
...
static inline void mavlink_msg_heartbeat_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t type, uint8_t autopilot, uint8_t base_mode, uint32_t custom_mode, uint8_t system_status)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HEARTBEAT_TUPLE, buf, MAVLINK_MSG_ID_HEARTBEAT_LEN, MAVLINK_MSG_ID_HEARTBEAT_CRC);
#else

...
#define MAVLINK_MSG_ID_POWER_STATUS_TUPLE 0, MAVLINK_MSG_ID_POWER_STATUS
#else
#define MAVLINK_MSG_ID_POWER_STATUS_TUPLE MAVLINK_MSG_ID_POWER_STATUS
#endif
...
static inline void mavlink_msg_power_status_send(mavlink_channel_t chan, uint16_t Vcc, uint16_t Vservo, uint16_t flags)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POWER_STATUS_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_POWER_STATUS_LEN, MAVLINK_MSG_ID_POWER_STATUS_CRC);
#endif
}
...
static inline void mavlink_msg_power_status_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t Vcc, uint16_t Vservo, uint16_t flags)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POWER_STATUS_TUPLE, buf, MAVLINK_MSG_ID_POWER_STATUS_LEN, MAVLINK_MSG_ID_POWER_STATUS_CRC);
#else

...
#define MAVLINK_MSG_ID_LANDING_TARGET_TUPLE 0, MAVLINK_MSG_ID_LANDING_TARGET
#else
#define MAVLINK_MSG_ID_LANDING_TARGET_TUPLE MAVLINK_MSG_ID_LANDING_TARGET
#endif
...
static inline void mavlink_msg_landing_target_send(mavlink_channel_t chan, uint64_t time_usec, uint8_t target_num, uint8_t frame, float angle_x, float angle_y, float distance, float size_x, float size_y)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LANDING_TARGET_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_LANDING_TARGET_LEN, MAVLINK_MSG_ID_LANDING_TARGET_CRC);
#endif
}
...
static inline void mavlink_msg_landing_target_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, uint8_t target_num, uint8_t frame, float angle_x, float angle_y, float distance, float size_x, float size_y)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LANDING_TARGET_TUPLE, buf, MAVLINK_MSG_ID_LANDING_TARGET_LEN, MAVLINK_MSG_ID_LANDING_TARGET_CRC);
#else

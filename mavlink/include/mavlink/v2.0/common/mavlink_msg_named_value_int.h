...
#define MAVLINK_MSG_ID_NAMED_VALUE_INT_TUPLE 0, MAVLINK_MSG_ID_NAMED_VALUE_INT
#else
#define MAVLINK_MSG_ID_NAMED_VALUE_INT_TUPLE MAVLINK_MSG_ID_NAMED_VALUE_INT
#endif
...
static inline void mavlink_msg_named_value_int_send(mavlink_channel_t chan, uint32_t time_boot_ms, const char *name, int32_t value)
{
	...
	packet.value = value;
	mav_array_memcpy(packet.name, name, sizeof(char)*10);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_NAMED_VALUE_INT_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_NAMED_VALUE_INT_LEN, MAVLINK_MSG_ID_NAMED_VALUE_INT_CRC);
#endif
}
...
static inline void mavlink_msg_named_value_int_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, const char *name, int32_t value)
{
	...
	_mav_put_int32_t(buf, 4, value);
	_mav_put_char_array(buf, 8, name, 10);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_NAMED_VALUE_INT_TUPLE, buf, MAVLINK_MSG_ID_NAMED_VALUE_INT_LEN, MAVLINK_MSG_ID_NAMED_VALUE_INT_CRC);
#else

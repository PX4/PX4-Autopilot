...
#define MAVLINK_MSG_ID_TERRAIN_CHECK_TUPLE 0, MAVLINK_MSG_ID_TERRAIN_CHECK
#else
#define MAVLINK_MSG_ID_TERRAIN_CHECK_TUPLE MAVLINK_MSG_ID_TERRAIN_CHECK
#endif
...
static inline void mavlink_msg_terrain_check_send(mavlink_channel_t chan, int32_t lat, int32_t lon)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_TERRAIN_CHECK_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_TERRAIN_CHECK_LEN, MAVLINK_MSG_ID_TERRAIN_CHECK_CRC);
#endif
}
...
static inline void mavlink_msg_terrain_check_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  int32_t lat, int32_t lon)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_TERRAIN_CHECK_TUPLE, buf, MAVLINK_MSG_ID_TERRAIN_CHECK_LEN, MAVLINK_MSG_ID_TERRAIN_CHECK_CRC);
#else

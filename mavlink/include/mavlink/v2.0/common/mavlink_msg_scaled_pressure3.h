...
#define MAVLINK_MSG_ID_SCALED_PRESSURE3_TUPLE 0, MAVLINK_MSG_ID_SCALED_PRESSURE3
#else
#define MAVLINK_MSG_ID_SCALED_PRESSURE3_TUPLE MAVLINK_MSG_ID_SCALED_PRESSURE3
#endif
...
static inline void mavlink_msg_scaled_pressure3_send(mavlink_channel_t chan, uint32_t time_boot_ms, float press_abs, float press_diff, int16_t temperature)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SCALED_PRESSURE3_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_SCALED_PRESSURE3_LEN, MAVLINK_MSG_ID_SCALED_PRESSURE3_CRC);
#endif
}
...
static inline void mavlink_msg_scaled_pressure3_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, float press_abs, float press_diff, int16_t temperature)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SCALED_PRESSURE3_TUPLE, buf, MAVLINK_MSG_ID_SCALED_PRESSURE3_LEN, MAVLINK_MSG_ID_SCALED_PRESSURE3_CRC);
#else

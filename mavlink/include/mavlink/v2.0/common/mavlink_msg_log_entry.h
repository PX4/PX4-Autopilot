...
#define MAVLINK_MSG_ID_LOG_ENTRY_TUPLE 0, MAVLINK_MSG_ID_LOG_ENTRY
#else
#define MAVLINK_MSG_ID_LOG_ENTRY_TUPLE MAVLINK_MSG_ID_LOG_ENTRY
#endif
...
static inline void mavlink_msg_log_entry_send(mavlink_channel_t chan, uint16_t id, uint16_t num_logs, uint16_t last_log_num, uint32_t time_utc, uint32_t size)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LOG_ENTRY_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_LOG_ENTRY_LEN, MAVLINK_MSG_ID_LOG_ENTRY_CRC);
#endif
}
...
static inline void mavlink_msg_log_entry_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t id, uint16_t num_logs, uint16_t last_log_num, uint32_t time_utc, uint32_t size)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LOG_ENTRY_TUPLE, buf, MAVLINK_MSG_ID_LOG_ENTRY_LEN, MAVLINK_MSG_ID_LOG_ENTRY_CRC);
#else

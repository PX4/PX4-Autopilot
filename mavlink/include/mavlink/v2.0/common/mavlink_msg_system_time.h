...
#define MAVLINK_MSG_ID_SYSTEM_TIME_TUPLE 0, MAVLINK_MSG_ID_SYSTEM_TIME
#else
#define MAVLINK_MSG_ID_SYSTEM_TIME_TUPLE MAVLINK_MSG_ID_SYSTEM_TIME
#endif
...
static inline void mavlink_msg_system_time_send(mavlink_channel_t chan, uint64_t time_unix_usec, uint32_t time_boot_ms)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SYSTEM_TIME_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_SYSTEM_TIME_LEN, MAVLINK_MSG_ID_SYSTEM_TIME_CRC);
#endif
}
...
static inline void mavlink_msg_system_time_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_unix_usec, uint32_t time_boot_ms)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SYSTEM_TIME_TUPLE, buf, MAVLINK_MSG_ID_SYSTEM_TIME_LEN, MAVLINK_MSG_ID_SYSTEM_TIME_CRC);
#else

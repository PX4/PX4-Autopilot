...
#define MAVLINK_MSG_ID_ATT_POS_MOCAP_TUPLE 0, MAVLINK_MSG_ID_ATT_POS_MOCAP
#else
#define MAVLINK_MSG_ID_ATT_POS_MOCAP_TUPLE MAVLINK_MSG_ID_ATT_POS_MOCAP
#endif
...
static inline void mavlink_msg_att_pos_mocap_send(mavlink_channel_t chan, uint64_t time_usec, const float *q, float x, float y, float z)
{
	...
	packet.z = z;
	mav_array_memcpy(packet.q, q, sizeof(float)*4);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ATT_POS_MOCAP_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_ATT_POS_MOCAP_LEN, MAVLINK_MSG_ID_ATT_POS_MOCAP_CRC);
#endif
}
...
static inline void mavlink_msg_att_pos_mocap_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, const float *q, float x, float y, float z)
{
	...
	_mav_put_float(buf, 32, z);
	_mav_put_float_array(buf, 8, q, 4);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ATT_POS_MOCAP_TUPLE, buf, MAVLINK_MSG_ID_ATT_POS_MOCAP_LEN, MAVLINK_MSG_ID_ATT_POS_MOCAP_CRC);
#else

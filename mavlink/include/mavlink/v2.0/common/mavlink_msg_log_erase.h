...
#define MAVLINK_MSG_ID_LOG_ERASE_TUPLE 0, MAVLINK_MSG_ID_LOG_ERASE
#else
#define MAVLINK_MSG_ID_LOG_ERASE_TUPLE MAVLINK_MSG_ID_LOG_ERASE
#endif
...
static inline void mavlink_msg_log_erase_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LOG_ERASE_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_LOG_ERASE_LEN, MAVLINK_MSG_ID_LOG_ERASE_CRC);
#endif
}
...
static inline void mavlink_msg_log_erase_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LOG_ERASE_TUPLE, buf, MAVLINK_MSG_ID_LOG_ERASE_LEN, MAVLINK_MSG_ID_LOG_ERASE_CRC);
#else

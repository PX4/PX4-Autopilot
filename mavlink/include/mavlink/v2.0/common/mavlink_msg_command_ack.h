...
#define MAVLINK_MSG_ID_COMMAND_ACK_TUPLE 0, MAVLINK_MSG_ID_COMMAND_ACK
#else
#define MAVLINK_MSG_ID_COMMAND_ACK_TUPLE MAVLINK_MSG_ID_COMMAND_ACK
#endif
...
static inline void mavlink_msg_command_ack_send(mavlink_channel_t chan, uint16_t command, uint8_t result)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_COMMAND_ACK_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_COMMAND_ACK_LEN, MAVLINK_MSG_ID_COMMAND_ACK_CRC);
#endif
}
...
static inline void mavlink_msg_command_ack_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t command, uint8_t result)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_COMMAND_ACK_TUPLE, buf, MAVLINK_MSG_ID_COMMAND_ACK_LEN, MAVLINK_MSG_ID_COMMAND_ACK_CRC);
#else

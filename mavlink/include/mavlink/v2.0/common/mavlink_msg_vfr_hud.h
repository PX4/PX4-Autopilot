...
#define MAVLINK_MSG_ID_VFR_HUD_TUPLE 0, MAVLINK_MSG_ID_VFR_HUD
#else
#define MAVLINK_MSG_ID_VFR_HUD_TUPLE MAVLINK_MSG_ID_VFR_HUD
#endif
...
static inline void mavlink_msg_vfr_hud_send(mavlink_channel_t chan, float airspeed, float groundspeed, int16_t heading, uint16_t throttle, float alt, float climb)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_VFR_HUD_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_VFR_HUD_LEN, MAVLINK_MSG_ID_VFR_HUD_CRC);
#endif
}
...
static inline void mavlink_msg_vfr_hud_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float airspeed, float groundspeed, int16_t heading, uint16_t throttle, float alt, float climb)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_VFR_HUD_TUPLE, buf, MAVLINK_MSG_ID_VFR_HUD_LEN, MAVLINK_MSG_ID_VFR_HUD_CRC);
#else

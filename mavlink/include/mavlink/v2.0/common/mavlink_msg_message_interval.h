...
#define MAVLINK_MSG_ID_MESSAGE_INTERVAL_TUPLE 0, MAVLINK_MSG_ID_MESSAGE_INTERVAL
#else
#define MAVLINK_MSG_ID_MESSAGE_INTERVAL_TUPLE MAVLINK_MSG_ID_MESSAGE_INTERVAL
#endif
...
static inline void mavlink_msg_message_interval_send(mavlink_channel_t chan, uint16_t message_id, int32_t interval_us)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MESSAGE_INTERVAL_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN, MAVLINK_MSG_ID_MESSAGE_INTERVAL_CRC);
#endif
}
...
static inline void mavlink_msg_message_interval_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t message_id, int32_t interval_us)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MESSAGE_INTERVAL_TUPLE, buf, MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN, MAVLINK_MSG_ID_MESSAGE_INTERVAL_CRC);
#else

...
#define MAVLINK_MSG_ID_MISSION_ITEM_REACHED_TUPLE 0, MAVLINK_MSG_ID_MISSION_ITEM_REACHED
#else
#define MAVLINK_MSG_ID_MISSION_ITEM_REACHED_TUPLE MAVLINK_MSG_ID_MISSION_ITEM_REACHED
#endif
...
static inline void mavlink_msg_mission_item_reached_send(mavlink_channel_t chan, uint16_t seq)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_ITEM_REACHED_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_MISSION_ITEM_REACHED_LEN, MAVLINK_MSG_ID_MISSION_ITEM_REACHED_CRC);
#endif
}
...
static inline void mavlink_msg_mission_item_reached_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t seq)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_ITEM_REACHED_TUPLE, buf, MAVLINK_MSG_ID_MISSION_ITEM_REACHED_LEN, MAVLINK_MSG_ID_MISSION_ITEM_REACHED_CRC);
#else

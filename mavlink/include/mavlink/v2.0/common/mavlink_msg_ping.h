...
#define MAVLINK_MSG_ID_PING_TUPLE 0, MAVLINK_MSG_ID_PING
#else
#define MAVLINK_MSG_ID_PING_TUPLE MAVLINK_MSG_ID_PING
#endif
...
static inline void mavlink_msg_ping_send(mavlink_channel_t chan, uint64_t time_usec, uint32_t seq, uint8_t target_system, uint8_t target_component)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PING_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_PING_LEN, MAVLINK_MSG_ID_PING_CRC);
#endif
}
...
static inline void mavlink_msg_ping_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, uint32_t seq, uint8_t target_system, uint8_t target_component)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PING_TUPLE, buf, MAVLINK_MSG_ID_PING_LEN, MAVLINK_MSG_ID_PING_CRC);
#else

...
#define MAVLINK_MSG_ID_SET_MODE_TUPLE 0, MAVLINK_MSG_ID_SET_MODE
#else
#define MAVLINK_MSG_ID_SET_MODE_TUPLE MAVLINK_MSG_ID_SET_MODE
#endif
...
static inline void mavlink_msg_set_mode_send(mavlink_channel_t chan, uint8_t target_system, uint8_t base_mode, uint32_t custom_mode)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_MODE_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_SET_MODE_LEN, MAVLINK_MSG_ID_SET_MODE_CRC);
#endif
}
...
static inline void mavlink_msg_set_mode_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t base_mode, uint32_t custom_mode)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_MODE_TUPLE, buf, MAVLINK_MSG_ID_SET_MODE_LEN, MAVLINK_MSG_ID_SET_MODE_CRC);
#else

...
#define MAVLINK_MSG_ID_AUTH_KEY_TUPLE 0, MAVLINK_MSG_ID_AUTH_KEY
#else
#define MAVLINK_MSG_ID_AUTH_KEY_TUPLE MAVLINK_MSG_ID_AUTH_KEY
#endif
...
static inline void mavlink_msg_auth_key_send(mavlink_channel_t chan, const char *key)
{
	...
	mav_array_memcpy(packet.key, key, sizeof(char)*32);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_AUTH_KEY_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_AUTH_KEY_LEN, MAVLINK_MSG_ID_AUTH_KEY_CRC);
#endif
}
...
static inline void mavlink_msg_auth_key_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const char *key)
{
	...
	_mav_put_char_array(buf, 0, key, 32);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_AUTH_KEY_TUPLE, buf, MAVLINK_MSG_ID_AUTH_KEY_LEN, MAVLINK_MSG_ID_AUTH_KEY_CRC);
#else

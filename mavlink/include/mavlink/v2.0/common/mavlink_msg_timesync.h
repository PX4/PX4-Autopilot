...
#define MAVLINK_MSG_ID_TIMESYNC_TUPLE 0, MAVLINK_MSG_ID_TIMESYNC
#else
#define MAVLINK_MSG_ID_TIMESYNC_TUPLE MAVLINK_MSG_ID_TIMESYNC
#endif
...
static inline void mavlink_msg_timesync_send(mavlink_channel_t chan, int64_t tc1, int64_t ts1)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_TIMESYNC_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_TIMESYNC_LEN, MAVLINK_MSG_ID_TIMESYNC_CRC);
#endif
}
...
static inline void mavlink_msg_timesync_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  int64_t tc1, int64_t ts1)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_TIMESYNC_TUPLE, buf, MAVLINK_MSG_ID_TIMESYNC_LEN, MAVLINK_MSG_ID_TIMESYNC_CRC);
#else

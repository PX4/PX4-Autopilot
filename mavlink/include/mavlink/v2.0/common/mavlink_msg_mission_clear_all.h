...
#define MAVLINK_MSG_ID_MISSION_CLEAR_ALL_TUPLE 0, MAVLINK_MSG_ID_MISSION_CLEAR_ALL
#else
#define MAVLINK_MSG_ID_MISSION_CLEAR_ALL_TUPLE MAVLINK_MSG_ID_MISSION_CLEAR_ALL
#endif
...
static inline void mavlink_msg_mission_clear_all_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_CLEAR_ALL_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_MISSION_CLEAR_ALL_LEN, MAVLINK_MSG_ID_MISSION_CLEAR_ALL_CRC);
#endif
}
...
static inline void mavlink_msg_mission_clear_all_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MISSION_CLEAR_ALL_TUPLE, buf, MAVLINK_MSG_ID_MISSION_CLEAR_ALL_LEN, MAVLINK_MSG_ID_MISSION_CLEAR_ALL_CRC);
#else

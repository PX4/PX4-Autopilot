...
#define MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_TUPLE 0, MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL
#else
#define MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_TUPLE MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL
#endif
...
static inline void mavlink_msg_change_operator_control_send(mavlink_channel_t chan, uint8_t target_system, uint8_t control_request, uint8_t version, const char *passkey)
{
	...
	packet.version = version;
	mav_array_memcpy(packet.passkey, passkey, sizeof(char)*25);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_LEN, MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_CRC);
#endif
}
...
static inline void mavlink_msg_change_operator_control_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t control_request, uint8_t version, const char *passkey)
{
	...
	_mav_put_uint8_t(buf, 2, version);
	_mav_put_char_array(buf, 3, passkey, 25);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_TUPLE, buf, MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_LEN, MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_CRC);
#else

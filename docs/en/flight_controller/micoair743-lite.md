...
You will need to enable the protocol by setting `SER_<tag>_PROTO`, such as [SER_RC_PROTO](../advanced_config/parameter_reference.md#SER_RC_PROTO) to CRSF for a [CRSF receiver](../telemetry/crsf_telemetry.md).

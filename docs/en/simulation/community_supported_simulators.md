...
| [X-Plane](../sim_xplane/index.md)        | <p>A commercial flight simulator using blade element theory for flight dynamics. The PX4 integration uses the community-supported px4xplane bridge plugin.</p><p><strong>Supported Vehicles:</strong> Plane, Multicopter, VTOL</p>                                                                                                                                                                                 |

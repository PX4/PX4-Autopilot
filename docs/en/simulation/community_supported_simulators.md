...
| [Newton](../sim_newton/index.md)         | <p>A GPU-accelerated physics engine by NVIDIA, Google DeepMind, and Disney Research. Uses the Warp framework (Python) for JIT-compiled simulation on GPU or CPU. PX4 runs decoupled and an external Newton-based simulator connects over the simulator MAVLink API.</p><p><strong>Supported Vehicles:</strong> Quad</p>                                                                                            |

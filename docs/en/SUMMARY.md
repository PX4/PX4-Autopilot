...
- [Hardware Selection & Setup](hardware/drone_parts.md)
  ...
  - [Sensors](sensor/index.md)
    ...
    - [RTK GNSS](gps_compass/rtk_gps.md)
      - [ArduSimple simpleRTK2B Budget](dronecan/ardusimple-simplertkb2b-budget.md)
      - [ArduSimple simpleRTK3B Pro](dronecan/ardusimple-simplertk3b-pro.md)
      - [ArduSimple simpleRTK3B Compass](dronecan/ardusimple-simplertk3b-compass.md)
...
- [Development](development/development.md)
  - [Getting Started](dev_setup/getting_started.md)
    ...
    - [Building the Code](dev_setup/building_px4.md)
      - [Building SITL Containers](dev_setup/sitl_container_builds.md)
  ...
  - [Simulation](simulation/index.md)
    ...
    - [Pre-built Packages](simulation/px4_sitl_prebuilt_packages.md)
      - [Gazebo Container GUI](simulation/gazebo_container_gui.md)
  ...
  - [Middleware](middleware/index.md)
    ...
    - [uORB Message Reference](msg_docs/index.md)
      ...
      - [Unversioned Messages](msg_docs/unversioned_messages.md)
        ...
        - [ExternalGimbalManagerStatus](msg_docs/ExternalGimbalManagerStatus.md)
        ...
        - [GimbalManagerSetPitchyaw](msg_docs/GimbalManagerSetPitchyaw.md)

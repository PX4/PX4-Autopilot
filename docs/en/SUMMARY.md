...
- [Hardware Selection & Setup](hardware/drone_parts.md)
  - [Flight Controllers (Autopilots)](flight_controller/index.md)
    ...
    - [Manufacturer-Supported Autopilots](flight_controller/autopilot_manufacturer_supported.md)
      ...
      - [Agam Autopilot v6X-RT](flight_controller/agam_autopilot-v6xrt.md)
  ...
  - [Sensors](sensor/index.md)
    ...
    - [GNSS (GPS)](gps_compass/index.md)
      - [Agam GNSS02 CAN](gps_compass/agam_gnss_01.md)
      - [Agam GNSS02 CAN](gps_compass/agam_gnss_02.md)
    ...
    - [Optical Flow](sensor/optical_flow.md)
      - [Agam FloRange](dronecan/agam_flo-range.md)
  ...
  - [Power Systems](power_systems/index.md)
    ...
    - [Power Modules/PDB](power_module/index.md)
      - [Agam DPM01 Digital Power Module](power_module/agam_dpm01_powermodule.md)
      - [Agam DPM02 Digital Power Module](power_module/agam_dpm02_powermodule.md)

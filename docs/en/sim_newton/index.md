...
[Newton](https://developer.nvidia.com/newton-physics) is an open-source (Apache 2.0) physics engine written in Python. It is developed by NVIDIA, Google DeepMind, and Disney Research, and managed by the Linux Foundation. It leverages the NVIDIA Warp Python framework for accelerated simulation using JIT compilation of kernel functions for GPU or CPU. It comes with modern features such as OpenUSD support and differentiable simulation.

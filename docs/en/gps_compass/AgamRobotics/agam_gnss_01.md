...
The Agam GNSS01 CAN is a Made in India GNSS/GPS module designed for PX4-compatible flight controllers. It features the u-blox NEO-M9N GNSS receiver integrated with an IMU, barometer, magnetometer, safety switch, and buzzer. The module communicates over the CAN interface and provides reliable positioning, navigation, and orientation for autonomous flight applications.

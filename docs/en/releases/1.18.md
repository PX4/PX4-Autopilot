...
- Added support for the [CUAV X25-MEGA](../flight_controller/cuav_x25-mega.md) flight controller. ([PX4-Autopilot#26664](https://github.com/PX4/PX4-Autopilot/pull/26664))
- Added support for the [CUAV X25-SUPER](../flight_controller/cuav_x25-super.md) flight controller. ([PX4-Autopilot#26474](https://github.com/PX4/PX4-Autopilot/pull/26474))
- Added support for the [Corvon V5](../flight_controller/corvon_v5.md) flight controller. ([PX4-Autopilot#26286](https://github.com/PX4/PX4-Autopilot/pull/26286))
- Added support for the [Corvon 743v2](../flight_controller/corvon_743v2.md) flight controller. ([PX4-Autopilot#27569](https://github.com/PX4/PX4-Autopilot/pull/27569))
- Added support for the [AEDROX AEDROXH7](../flight_controller/aedrox_aedroxh7.md) STM32H743-based FPV/racing flight controller (ICM-42688-P IMU, DPS310 barometer, W25N NAND flash, MAX7456 OSD, 8 bidirectional-DShot outputs). ([PX4-Autopilot#27226](https://github.com/PX4/PX4-Autopilot/pull/27226))
- Added support for the [CBUnmanned H753-SOM](../flight_controller/cbunmanned_h753-som.md) System-on-Module flight controller. ([PX4-Autopilot#27234](https://github.com/PX4/PX4-Autopilot/pull/27234))
- Added support for the [3DR Control N1](../flight_controller/3dr_ctrl-n1.md) flight controller. This board bring-up also introduced the AKM AK09940A magnetometer driver. ([PX4-Autopilot#27395](https://github.com/PX4/PX4-Autopilot/pull/27395))
- Added support for the ARK FMU-v6s flight controller, a low-cost variant of the ARK V6X (single IIM-42653 IMU, IIS2MDC magnetometer, BMP390 barometer). ([PX4-Autopilot#26631](https://github.com/PX4/PX4-Autopilot/pull/26631))
- Added support for the [Gear Up AirBrainH743](../flight_controller/gearup_airbrainh743.md) flight controller. ([PX4-Autopilot#26239](https://github.com/PX4/PX4-Autopilot/pull/26239))
- Added support for the [X-MAV AP-H743r1](../flight_controller/x-mav_ap-h743r1.md) flight controller. ([PX4-Autopilot#25967](https://github.com/PX4/PX4-Autopilot/pull/25967))
- Added support for the [MicoAir H743-Lite](../flight_controller/micoair743-lite.md) flight controller. ([PX4-Autopilot#25777](https://github.com/PX4/PX4-Autopilot/pull/25777))
- Added support for the [SVehicle-E2](../flight_controller/svehicle_e2.md) flight controller. ([PX4-Autopilot#25578](https://github.com/PX4/PX4-Autopilot/pull/25578))
- Added support for the ARK MAG DroneCAN magnetometer node. ([PX4-Autopilot#25822](https://github.com/PX4/PX4-Autopilot/pull/25822))
- Added a firmware-release build target for the SAAM saampixv1_1 flight controller.
- Added the Sony AS-DT1 [distance sensor](../sensor/sony_asdt1.md) driver, with mounting orientation configurable via a rotation parameter (enabled on FMU-v6XRT). ([PX4-Autopilot#27769](https://github.com/PX4/PX4-Autopilot/pull/27769))
- Added the Analog Devices ADIS1657x IMU driver. ([PX4-Autopilot#27239](https://github.com/PX4/PX4-Autopilot/pull/27239))
- Added the Analog Devices ADIS1650x IMU driver (ADIS16500/16501/16505/16507 family). ([PX4-Autopilot#27240](https://github.com/PX4/PX4-Autopilot/pull/27240))
- Added the ST LSM6DSV16X IMU driver, enabled as a probe-based alternative IMU on [Pixhawk 6C](../flight_controller/pixhawk6c.md). ([PX4-Autopilot#26951](https://github.com/PX4/PX4-Autopilot/pull/26951))
- Added LSM6DSV 32X and DSK320X variant support to the ST LSM6DSV IMU driver. ([PX4-Autopilot#27523](https://github.com/PX4/PX4-Autopilot/pull/27523))
- Added a driver for the Hiwonder 4-channel encoder motor module, enabled via [HIWONDER_EMM_EN](../advanced_config/parameter_reference.md#HIWONDER_EMM_EN) (started from `rc.rover`). ([PX4-Autopilot#27229](https://github.com/PX4/PX4-Autopilot/pull/27229))
- Added a driver for the TI ADS7128 I2C ADC. ([PX4-Autopilot#26471](https://github.com/PX4/PX4-Autopilot/pull/26471))
- Added AUAV L60D support to the AUAV differential pressure sensor driver. ([PX4-Autopilot#27219](https://github.com/PX4/PX4-Autopilot/pull/27219))
- Added Infineon DPS368 support to the DPS310 barometer driver, selectable with the `-8` start flag. ([PX4-Autopilot#27724](https://github.com/PX4/PX4-Autopilot/pull/27724))
- VectorNav INS driver: added options to select the IMU output rate and the serial output port. ([PX4-Autopilot#27318](https://github.com/PX4/PX4-Autopilot/pull/27318))
...
- Added ICM45686 IMU support to the Accton Godwit GA1. ([PX4-Autopilot#27281](https://github.com/PX4/PX4-Autopilot/pull/27281))
- Added TDK IIM42652 IMU and Bosch BMP581 barometer support to the ZeroOne X6 Series V2. ([PX4-Autopilot#27475](https://github.com/PX4/PX4-Autopilot/pull/27475))
- Added BMM350 compass compatibility to the ZeroOne X6. ([PX4-Autopilot#26870](https://github.com/PX4/PX4-Autopilot/pull/26870))
- Added an RM3100 fallback for the internal compass on [Pixhawk 6C](../flight_controller/pixhawk6c.md). ([PX4-Autopilot#27299](https://github.com/PX4/PX4-Autopilot/pull/27299))
- Added INA226 and INA228 power monitor driver support to the ModalAI VOXL 2, selectable via the `POWER_MANAGER` startup option. ([PX4-Autopilot#26840](https://github.com/PX4/PX4-Autopilot/pull/26840))
- Enabled the Lightware laser rangefinder driver on the ModalAI VOXL 2. ([PX4-Autopilot#27620](https://github.com/PX4/PX4-Autopilot/pull/27620))
- Added an airship build variant for the FMU-v6x (`make px4_fmu-v6x_airship`), enabling the airship attitude controller and Cloudship airframe while disabling the multicopter, fixed-wing, and VTOL controllers. ([PX4-Autopilot#27739](https://github.com/PX4/PX4-Autopilot/pull/27739))
...
- SIH: Add option to set wind velocity ([PX4-Autopilot#26467](https://github.com/PX4/PX4-Autopilot/pull/26467))
...
- Gazebo: the [gstreamer plugin](../sim_gazebo_gz/index.md) now supports streaming video from multiple cameras/vehicles simultaneously over UDP (base port plus instance offset); RTMP remains single-stream. ([PX4-Autopilot#27275](https://github.com/PX4/PX4-Autopilot/pull/27275))
- SITL: MAVLink can now be bound to a specific network interface by setting the `PX4_NET_INTERFACE` environment variable. ([PX4-Autopilot#26385](https://github.com/PX4/PX4-Autopilot/pull/26385))
- SIH: added a quadratic thrust model and a hexacopter (`sihsim_hex`) airframe for more realistic multirotor simulation. ([PX4-Autopilot#26587](https://github.com/PX4/PX4-Autopilot/pull/26587))
- SIH: added a propeller aerodynamic model with advance ratio, plus new HIL airframes including a hexacopter (`1105_rc_hexa_x_sih`). ([PX4-Autopilot#26720](https://github.com/PX4/PX4-Autopilot/pull/26720))
- SIH: added ranging-beacon simulation with configurable measurement noise via [SIH_RNGBC_NOISE](../advanced_config/parameter_reference.md#SIH_RNGBC_NOISE) (default `30` m). ([PX4-Autopilot#26772](https://github.com/PX4/PX4-Autopilot/pull/26772))
- SITL: the simulated GPS (`sensor_gps_sim`) now supports failure injection via `MAV_CMD_INJECT_FAILURE` (`FAILURE_UNIT_SENSOR_GPS`) with off, stuck, and wrong modes, selectable per receiver. ([PX4-Autopilot#27396](https://github.com/PX4/PX4-Autopilot/pull/27396))
- SITL: the simulated airspeed sensor (`sensor_airspeed_sim`) now supports off, stuck, and wrong failure injection via `MAV_CMD_INJECT_FAILURE`. ([PX4-Autopilot#27006](https://github.com/PX4/PX4-Autopilot/pull/27006))
- SIH: the simulator now publishes ESC telemetry (per-motor RPM and temperature) for testing ESC status handling in SITL. ([PX4-Autopilot#27626](https://github.com/PX4/PX4-Autopilot/pull/27626))
...
- HIL: sensor calibration is now disabled while running in hardware-in-the-loop, preventing accidental calibration of simulated sensors. ([PX4-Autopilot#26942](https://github.com/PX4/PX4-Autopilot/pull/26942))
...
- Build: SPDX 2.3 SBOM (software bill of materials) generation is now integrated into the firmware build via `cmake/sbom.cmake`. SBOMs are produced automatically as part of the build and can be disabled by setting the `PX4_SBOM_DISABLE=1` environment variable. ([PX4-Autopilot#26731](https://github.com/PX4/PX4-Autopilot/pull/26731))
- Build/upload: firmware upload now works from WSL2. When building inside WSL2, the uploader detects and uses the Windows Python interpreter (`python.exe`) to reach `COM<N>` serial ports that WSL2 cannot expose directly. ([PX4-Autopilot#27674](https://github.com/PX4/PX4-Autopilot/pull/27674))
- Tools: new `make format_changed` target formats only files that differ from `HEAD` (via astyle), which is much faster than `make format` scanning the whole tree. ([PX4-Autopilot#27122](https://github.com/PX4/PX4-Autopilot/pull/27122))
- Tools: added DroneCAN sensor latency calibration scripts under `Tools/dronecan_calibration/` (`range_sensor_latency.py`, `flow_sensor_latency.py`) that cross-correlate CAN sensor signals against the FC's directly-connected IMU in flight logs to estimate CAN transport/pipeline delay.
...
- Added support for the `MAV_CMD_DO_SET_GLOBAL_ORIGIN` command, letting a GCS set the global origin used to convert local to global position. ([PX4-Autopilot#24697](https://github.com/PX4/PX4-Autopilot/pull/24697))

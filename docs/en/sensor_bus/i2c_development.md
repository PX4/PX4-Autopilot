...
:::tip
For example, you can see/search for `CONFIG_DRIVERS_DISTANCE_SENSOR_LIGHTWARE_LASER_I2C` in the [px4_fmu-v4_vtol](https://github.com/PX4/PX4-Autopilot/blob/main/boards/px4/fmu-v4/base.px4board) configuration.
:::

...
The flow modules may be mounted with any yaw orientation relative to the vehicle body frame, but you must set the value used in [SENS_FLOW0_ROT](../advanced_config/parameter_reference.md#SENS_FLOW0_ROT).
...
The diagram shows the relative board and vehicle orientations that correspond to `SENS_FLOW0_ROT=0` (note the notch at the back).
...
- [SENS_FLOW0_ROT](../advanced_config/parameter_reference.md#SENS_FLOW0_ROT) sets the orientation of the flow sensor relative to vehicle heading.

...
The document explains how you can include the module in your PX4 build, and provides a broad overview of how it works.
...
The module has been tested on the a number of configurations, which can be build locally using the commands:

...
MAVLink is unauthenticated by default, so a telemetry radio link is open to anyone in range unless you secure it. See [Security](../security/index.md) for how to harden the connection.

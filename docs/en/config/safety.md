...
| <a id="COM_ARM_WO_GPOS"></a>[COM_ARM_WO_GPOS](../advanced_config/parameter_reference.md#COM_ARM_WO_GPOS)    | Enable arming without a global position estimate. `0`: Disabled, `1`: Enabled (default).                                                                                                                   |

...
The [MAVLink instance](../peripherals/mavlink_peripherals.md#mavlink-instances) is the stream on a UART whose `SER_*_PROTO` is MAVLink (instance 0 is the first such UART); ethernet MAVLink is instance 2.

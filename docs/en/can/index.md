...
At runtime you can check what CAN ports are enabled and their status using the following command on the [MAVLink Shell](http://localhost:5173/px4_user_guide/en/debug/mavlink_shell) (or some other console):

...
| <a id="#DEVICE_TYPE_AIRSPEED"></a> DEVICE_TYPE_AIRSPEED                                                | `uint8` | 1     | 풍속 센서                  |
...
| <a id="#DEVICE_TYPE_MAGNETOMETER"></a> DEVICE_TYPE_MAGNETOMETER                                        | `uint8` | 5     | 자기 센서                  |
| <a id="#DEVICE_TYPE_PARACHUTE"></a> DEVICE_TYPE_PARACHUTE                                              | `uint8` | 6     | 낙하산                    |
...
| <a id="#DEVICE_TYPE_BAROMETER"></a> DEVICE_TYPE_BAROMETER                                              | `uint8` | 9     | 기압계                    |

...
| 형식                 | 출력                                               | 설명                                                              |
| ------------------ | ------------------------------------------------ | --------------------------------------------------------------- |
| 매개변수               | `docs/en/advanced_config/parameter_reference.md` | Complete parameter reference                                    |
| 기체                 | `docs/en/airframes/airframe_reference.md`        | Airframe configurations                                         |
| 모듈                 | `docs/en/modules/*.md`                           | Module documentation                                            |

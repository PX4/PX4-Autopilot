...
| Silkscreen | MCU pin | 颜色 | 功能                                                                                              |
| ---------- | ------- | -- | ----------------------------------------------------------------------------------------------- |
| LED1       | PE2     | 蓝色 | MCU activity, solid when armed                                                                  |
| LED2       | -       | 绿色 | IMU power-supply indicator                                                                      |
| LED3       | -       | 绿色 | MCU / baro / OSD power-supply indicator                                                         |
| LED4       | PE5     | 绿色 | MCU activity, blinks based on flight state (preflight / disarmed / failsafe) |
...
| 功能              | MCU pin   | 备注                                                                                                                                                       |
| --------------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 蜂鸣器             | PA7       | Drives an NPN low-side switch, use a basic 2-pin active buzzer (e.g. TMB12A05)                        |

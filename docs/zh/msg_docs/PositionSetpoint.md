...
| <a id="fld_loiter_radius"></a>loiter_radius                                                                                     | `float32` | 米                                                                | [0 : INF]  | loiter major axis radius                                                                                                                       |
| <a id="fld_loiter_minor_radius"></a>loiter_minor_radius                                                    | `float32` | 米                                                                | [0 : INF]  | loiter minor axis radius (used for non-circular loiter shapes)                                                              |

...
| <a id="fld_alt"></a>alt                                                                                                    | `float32` | 米                                                                |                   | Altitude above mean sea level (AMSL) (Invalid: NaN)                                                             |
| <a id="fld_eph"></a>eph                                                                                                    | `float32` | 米                                                                |                   | Std dev of horizontal position, lower bounded by NOISE param (Invalid: NaN)                                                        |
| <a id="fld_epv"></a>epv                                                                                                    | `float32` | 米                                                                |                   | Std dev of vertical position, lower bounded by NOISE param (Invalid: NaN)                                                          |
...
| <a id="#SOURCE_ESTIMATOR"></a> SOURCE_ESTIMATOR     | `uint8` | 6 | 估计器                                         |

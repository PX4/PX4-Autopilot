...
| <a id="fld_altitude_msl_m"></a>altitude_msl_m            | `float32` | 米                                                                |            | Altitude above MSL                               |
| <a id="fld_eph"></a>eph                                                                            | `float32` | 米                                                                |            | GNSS horizontal position accuracy                |
| <a id="fld_epv"></a>epv                                                                            | `float32` | 米                                                                |            | GNSS vertical position accuracy                  |
| <a id="fld_abs_pos_updated"></a>abs_pos_updated          | `bool`    |                                                                  |            | True if WGS84 position is updated                |
| <a id="fld_vel_n_m_s"></a>vel_n_m_s | `float32` | 米/秒                                                              |            | GNSS North velocity                              |
| <a id="fld_vel_e_m_s"></a>vel_e_m_s | `float32` | 米/秒                                                              |            | GNSS East velocity                               |
| <a id="fld_vel_d_m_s"></a>vel_d_m_s | `float32` | 米/秒                                                              |            | GNSS Down velocity                               |
| <a id="fld_s_acc_m_s"></a>s_acc_m_s | `float32` | 米/秒                                                              |            | GNSS speed accuracy estimate                     |

...
| <a id="fld_cruising_speed"></a>cruising_speed | `float32`    | 米/秒                                                              | [0 : inf]    | Cruising speed (Invalid: NaN Defaults to maximum speed)                                                  |
| <a id="fld_arrival_speed"></a>arrival_speed   | `float32`    | 米/秒                                                              | [0 : inf]    | Speed the rover should arrive at the target with (Invalid: NaN Defaults to 0)                            |

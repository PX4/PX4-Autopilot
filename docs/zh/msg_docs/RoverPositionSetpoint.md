...
| cruising_speed | `float32`    | 米/秒                                                              | [0 : inf]    | Cruising speed (Invalid: NaN Defaults to maximum speed)                                                  |
| arrival_speed  | `float32`    | 米/秒                                                              | [0 : inf]    | Speed the rover should arrive at the target with (Invalid: NaN Defaults to 0)                            |

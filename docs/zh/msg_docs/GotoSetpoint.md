...
| <a id="fld_max_horizontal_speed"></a>max_horizontal_speed                                                             | `float32`    | 米/秒                                                              |            | (optional) Maximum speed (absolute) in the NE-plane                                                                       |
...
| <a id="fld_max_vertical_speed"></a>max_vertical_speed                                                                 | `float32`    | 米/秒                                                              |            | (optional) Maximum speed (absolute) in the D-axis                                                                         |

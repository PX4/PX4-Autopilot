...
| <a id="fld_windspeed_north"></a>windspeed_north                                               | `float32` | 米/秒                                                              |            | Wind component in north / X direction                                                                                |
| <a id="fld_windspeed_east"></a>windspeed_east                                                 | `float32` | 米/秒                                                              |            | Wind component in east / Y direction                                                                                 |
...
| <a id="fld_tas_innov"></a>tas_innov                                                           | `float32` | 米/秒                                                              |            | True airspeed innovation                                                                                             |
| <a id="fld_tas_innov_var"></a>tas_innov_var                              | `float32` | 米/秒                                                              |            | True airspeed innovation variance                                                                                    |

...
| <a id="fld_altitude"></a>altitude                                | `float32`   | 米                                                                |                                                                                   | Altitude (ASL), validity flag: PX4_ADSB_FLAGS_VALID_ALTITUDE       |
| <a id="fld_heading"></a>heading                                  | `float32`   | rad                                                              |                                                                                   | Course over ground, 0 to 2pi, 0 is north, validity flag: PX4_ADSB_FLAGS_VALID_HEADING |
| <a id="fld_hor_velocity"></a>hor_velocity   | `float32`   | 米/秒                                                              |                                                                                   | Horizontal velocity, validity flag: PX4_ADSB_FLAGS_VALID_VELOCITY                     |
| <a id="fld_ver_velocity"></a>ver_velocity   | `float32`   | 米/秒                                                              |                                                                                   | Vertical velocity, positive is up, validity flag: PX4_ADSB_FLAGS_VALID_VELOCITY       |

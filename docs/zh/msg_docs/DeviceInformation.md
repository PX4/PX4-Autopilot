...
| <a id="#DEVICE_TYPE_AIRSPEED"></a> DEVICE_TYPE_AIRSPEED                                                | `uint8` | 1  | 空速传感器                  |
...
| <a id="#DEVICE_TYPE_MAGNETOMETER"></a> DEVICE_TYPE_MAGNETOMETER                                        | `uint8` | 5  | 磁力计                    |
| <a id="#DEVICE_TYPE_PARACHUTE"></a> DEVICE_TYPE_PARACHUTE                                              | `uint8` | 6  | 降落伞                    |

...
| <a id="fld_range"></a>range                                            | `float32` | 米                                                                |                                            | Range measurement                                                                   |
| <a id="fld_lat"></a>lat                                                | `float64` | deg                                                              |                                            | Latitude                                                                            |
| <a id="fld_lon"></a>lon                                                | `float64` | deg                                                              |                                            | Longitude                                                                           |
| <a id="fld_alt"></a>alt                                                | `float32` | 米                                                                |                                            | Beacon altitude (frame defined in alt_type) |
| <a id="fld_alt_type"></a>alt_type                 | `uint8`   |                                                                  | [ALT_TYPE](#ALT_TYPE) | Altitude frame for alt field                                                        |
| <a id="fld_hacc"></a>hacc                                              | `float32` | 米                                                                |                                            | Groundbeacon horizontal accuracy                                                    |
| <a id="fld_vacc"></a>vacc                                              | `float32` | 米                                                                |                                            | Groundbeacon vertical accuracy                                                      |
...
| <a id="fld_range_accuracy"></a>range_accuracy     | `float32` | 米                                                                |                                            | Range accuracy estimate                                                             |

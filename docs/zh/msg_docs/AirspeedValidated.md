...
| indicated_airspeed_m_s                                                     | `float32` | 米/秒                                                              |                   | Indicated airspeed (IAS) (Invalid: NaN)                                                                   |
| calibrated_airspeed_m_s                                                    | `float32` | 米/秒                                                              |                   | Calibrated airspeed (CAS) (Invalid: NaN)                                                                  |
| true_airspeed_m_s                                                          | `float32` | 米/秒                                                              |                   | True airspeed (TAS) (Invalid: NaN)                                                                        |
| airspeed_source                                                                                                      | `int8`    |                                                                  | [SOURCE](#SOURCE) | Source of currently published airspeed values                                                                                                                   |
| calibrated_ground_minus_wind_m_s | `float32` | 米/秒                                                              |                   | CAS calculated from groundspeed - windspeed, where windspeed is estimated based on a zero-sideslip assumption (Invalid: NaN) |
| calibraded_airspeed_synth_m_s                         | `float32` | 米/秒                                                              |                   | Synthetic airspeed (Invalid: NaN)                                                                                            |

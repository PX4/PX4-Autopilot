...
| Порт      | MCU peripheral | Пристрій   | Функція                                         |
| --------- | -------------- | ---------- | ----------------------------------------------- |
| `SERIAL1` | USART1         | /dev/ttyS0 | TELEM1 (MAVLink)             |
| `SERIAL2` | USART2         | /dev/ttyS1 | GPS1                                            |
| `SERIAL3` | USART3         | /dev/ttyS2 | Вхід RC                                         |
...
| Silkscreen | MCU pin | Колір   | Функція                                                                                         |
| ---------- | ------- | ------- | ----------------------------------------------------------------------------------------------- |
| LED1       | PE2     | Синій   | MCU activity, solid when armed                                                                  |
| LED2       | -       | Зелений | IMU power-supply indicator                                                                      |
| LED3       | -       | Зелений | MCU / baro / OSD power-supply indicator                                                         |
| LED4       | PE5     | Зелений | MCU activity, blinks based on flight state (preflight / disarmed / failsafe) |
| LED5       | -       | -       | 10v VTX rail indicator (lit when VTX power is enabled)                       |

### Other I/O

| Функція         | MCU pin   | Примітки                                                                                                                                                 |
| --------------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Зумер           | PA7       | Drives an NPN low-side switch, use a basic 2-pin active buzzer (e.g. TMB12A05)                        |

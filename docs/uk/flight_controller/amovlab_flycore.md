...
| ------ | ---------- | --------------- | :----------: |
| USART2 | /dev/ttyS0 | `TELEM1`        |      Так     |
| USART3 | /dev/ttyS1 | `TELEM2`        |      Ні      |
| UART4  | /dev/ttyS2 | `GPS1`          |      Ні      |
| UART5  | /dev/ttyS3 | `TELEM3`        |      Ні      |
| USART6 | /dev/ttyS4 | `RC`            |      Ні      |
| UART7  | /dev/ttyS5 | `GPS2`          |      Ні      |
| UART8  | /dev/ttyS6 | `Debug Console` |      Ні      |

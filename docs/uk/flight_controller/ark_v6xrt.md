...
| IMU        | Шина | Full scale                          | Publish rate |
| ---------- | ---- | ----------------------------------- | ------------ |
...
| -------- | ---------- | --------------- | :----------: |
| LPUART1  | /dev/ttyS0 | `Debug Console` |      Ні      |
| LPUART3  | /dev/ttyS1 | `GPS1`          |      Ні      |
| LPUART4  | /dev/ttyS2 | `TELEM1`        |      Так     |
| LPUART5  | /dev/ttyS3 | `GPS2`          |      Ні      |
| LPUART6  | /dev/ttyS4 | PX4IO / `RC`    |      Ні      |
| LPUART8  | /dev/ttyS5 | `TELEM2`        |      Так     |
| LPUART10 | /dev/ttyS6 | `TELEM3`        |      Так     |
| LPUART11 | /dev/ttyS7 | `TELEM4`        |      Ні      |

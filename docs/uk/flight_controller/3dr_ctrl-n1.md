...
| З’єднання | Піни | Part Number                                                                                     | Signals                                                    |
| --------- | ---- | ----------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
...
| Порт | З’єднання | Peripheral | Flow Control | Default Function |
| ---- | --------- | ---------- | ------------ | ---------------- |
| SG1  | J100      | USART2     | Так          | TELEM1           |
| SG2  | J100      | UART4      | Так          | TELEM2           |
| SG3  | J300      | UART7      | Так          | User             |
| SG4  | J100      | USART3     | Ні           | GPS2             |
| SG5  | J100      | USART1     | Ні           | User             |
| SG6  | J200      | USART6     | Ні           | RC               |
| SG7  | J300      | UART8      | Ні           | GPS1             |

...
def check_itcm(elf_path: Path, script_pathes: List[Path]):
    """
    ...
    :param script_pathes: Path of all linker scripts that should be checked.
    """
    ...
    input_sections = []
    for script_path in script_pathes:
...
def main():
    ...
    parser.add_argument(
        "--script-files",
        help="Pathes of the linker script files",
        nargs="+",
        type=Path,
        required=True
    )

...
msg_id_map = {
    ...
    'vehicle_vision_position': 88,
    'vehicle_local_position_groundtruth': 89,
    'vehicle_local_position_setpoint': 90,
    'vehicle_rates_setpoint': 91,
    'vehicle_roi': 92,
    'vehicle_status_flags': 93,
    'vehicle_status': 94,
    'vtol_vehicle_status': 95,
    'wind_estimate': 96,
}

...
#ifndef __BOARDS_AGAM_FMU_V6XRT_SRC_IMXRT_FLEXSPI_NOR_BOOT_H
#define __BOARDS_AGAM_FMU_V6XRT_SRC_IMXRT_FLEXSPI_NOR_BOOT_H
...
#endif /* __BOARDS_AGAM_FMU_V6XRT_SRC_IMXRT_FLEXSPI_NOR_BOOT_H */

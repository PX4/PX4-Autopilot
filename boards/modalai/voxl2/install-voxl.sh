...
adb push build/modalai_voxl2_slpi_default/platforms/qurt/libpx4.so /usr/lib/rfsa/adsp

# Push apps processor image to voxl2
adb push build/modalai_voxl2_apps_default/bin/px4 /usr/bin

# Push scripts to voxl2
adb push build/modalai_voxl2_apps_default/bin/px4-alias.sh /usr/bin

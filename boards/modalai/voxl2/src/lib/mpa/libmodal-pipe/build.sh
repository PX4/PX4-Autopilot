...
TOOLCHAIN_QRB5165_2_32="/opt/cross_toolchain/qrb5165_ubun2_20.04_arm32.toolchain.cmake"
...
print_usage(){
	...
	echo "        Build 64-bit binaries for qcs640 system images"
	echo ""
